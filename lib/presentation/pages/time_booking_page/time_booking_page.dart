        ...
        Column(
          ...
          children: [
            ...
            ...options(
              ...
              converter: (date) => DateFormat('yMd').format(date),
              onTap: (object) => setState(() {
                selectedDate = object;
              }),
            ),
            verticalSpace(24),
            ...options(
              title: 'Selecione o horário do filme',
              options: hours,
                  ...
                  child: ElevatedButton(
                      ...
                      onPressed: () {
                        if (selectedDate == null ||
                          ...
                          context.showSnacBar('Selecione todas as opções');
                        } else {
